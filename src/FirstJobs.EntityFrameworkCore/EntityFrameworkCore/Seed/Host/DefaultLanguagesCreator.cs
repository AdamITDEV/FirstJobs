...
namespace FirstJobs.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly FirstJobsDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = FirstJobsConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FirstJobsDbContext context)
        {
            _context = context;
        }
