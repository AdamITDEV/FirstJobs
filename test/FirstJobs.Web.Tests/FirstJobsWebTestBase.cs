...
{
    public abstract class FirstJobsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FirstJobsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FirstJobsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FirstJobsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FirstJobsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FirstJobsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FirstJobsDbContext, Task<T>> func)
        {
            T result;
